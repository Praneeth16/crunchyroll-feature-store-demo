...
| peak achieved req/s | ~206 (see above) | **53.8** |
| 429s observed | 8,770 @ conc 48 | **none, at any level** |
...
A p95 of 400 ms from a laptop and 67 ms from a job are the same endpoint; only one of them
